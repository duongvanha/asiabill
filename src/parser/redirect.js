...
const schemaRedirectRequest = Joi.object({
  ...
  x_customer_billing_address1: Joi.string(),
  x_customer_billing_address2: Joi.string(),
  ...
  x_customer_shipping_address1: Joi.string(),
  x_customer_shipping_address2: Joi.string(),
...
async function parseOrderRequest(request) {
  ...
  return {
    ...
    shippingAddress: {
      ...
      line1: value['x_customer_shipping_address1'],
      city: value['x_customer_shipping_city'],
      state: value['x_customer_shipping_state'],
      line2: value['x_customer_shipping_address2'],
    },
